...
def test(data,
    ...
    if save_json and len(jdict):
        f = 'detections_test-dev2017_%s_results.json' % \
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            cocoGt = COCO(glob.glob('./data/coco/annotations/image_info_test-dev*.json')[0])
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='test_testdev2017.py')
